    ...
    def _load_data(self, db: Session) -> pd.DataFrame:
        ...
        sql = """
            SELECT 
                ...
                ROUND(((1.0 * COALESCE(m.micro_enterprises, 0)) / NULLIF(COALESCE(m.micro_enterprises, 0) + COALESCE(m.small_enterprises, 0) + COALESCE(m.medium_enterprises, 0), 0) * 100), 2) AS micro_share,
                ROUND(((1.0 * COALESCE(m.small_enterprises, 0)) / NULLIF(COALESCE(m.micro_enterprises, 0) + COALESCE(m.small_enterprises, 0) + COALESCE(m.medium_enterprises, 0), 0) * 100), 2) AS small_share,
                ROUND(((1.0 * COALESCE(m.medium_enterprises, 0)) / NULLIF(COALESCE(m.micro_enterprises, 0) + COALESCE(m.small_enterprises, 0) + COALESCE(m.medium_enterprises, 0), 0) * 100), 2) AS medium_share,
                ROUND(((1.0 * (COALESCE(m.small_enterprises, 0) + COALESCE(m.medium_enterprises, 0))) / NULLIF(COALESCE(m.micro_enterprises, 0) + COALESCE(m.small_enterprises, 0) + COALESCE(m.medium_enterprises, 0), 0) * 100), 2) AS small_medium_share,
